...
probe "ollama tags"        "docker compose exec -T ollama wget -qO- http://localhost:11434/api/tags"
probe "qdrant ready"       "docker compose exec -T qdrant wget -qO- http://localhost:6333/readyz"
probe "prometheus ready"   "docker compose exec -T prometheus wget -qO- http://localhost:9090/-/ready"
probe "loki ready"         "docker compose exec -T loki wget -qO- http://localhost:3100/ready"
probe "grafana healthz"    "docker compose exec -T grafana wget -qO- http://localhost:3000/api/health"
